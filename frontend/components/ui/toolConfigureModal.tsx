...
const ToolConfigureModal: React.FC<IProps> = (props) => {
    ...
    >
		<Dialog.Portal>
			<Dialog.Content 
                className="bg-white rounded-md shadow-lg fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-100 p-6 animate-[contentShow_150ms_cubic-bezier(0.16,1,0.3,1)]"
